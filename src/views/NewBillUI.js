            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="file" class="form-control blue-border" id="file" data-testid="file" accept=".jpg, .jpeg, .png" />
                    <p id ="file-error-message" class="hidden">Format de fichier invalide</p>
                  </div>
                </div>
            </div>
            <div class="row">
